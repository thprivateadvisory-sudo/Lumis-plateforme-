      ...
      <div className="w" style={{ maxWidth: 800 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 40 }}>
          {[
            ...
            { title: '3. Compte utilisateur', content: `Vous êtes responsable de la confidentialité de vos identifiants de connexion. Tout accès effectué depuis votre compte est réputé effectué par vous. En cas de compromission de votre compte, vous devez notifier Cohesif immédiatement à support@cohesif-ia.fr.` },
